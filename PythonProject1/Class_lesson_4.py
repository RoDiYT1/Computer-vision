...
img = cv2.imread("images/chel.jpeg")
...
img_copy = cv2.equalizeHist(img_copy)  # + contrast
...
for cnt in contours:
    ...
    if area > 100:
        ...
        cv2.putText(img_copy_color, text, (x, text_y), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 100, 100), 2)
cv2.imshow("img", img)
